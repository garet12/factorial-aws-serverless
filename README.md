...
├── validate                    <-- Source code for a lambda function
│   ├── app.py                  <-- Lambda function code
│   ├── requirements.txt        <-- Lambda function code
├── calculate                   <-- Source code for a lambda function
│   ├── app.py                  <-- Lambda function code
│   ├── requirements.txt        <-- Lambda function code
├── terraform.tf                <-- Terraform template
...
* (Optional) [Terraform installed](https://www.terraform.io/)
